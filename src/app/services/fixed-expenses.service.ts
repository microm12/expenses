...
export class FixedExpensesService {
  ...
  private fixedExpenses: FixedExpense[] = [
    ...
    new FixedExpense('Supplier E', 23, 512.2, 25, '25th', 3, new Date('01-10-2019'), new Date('05-24-2019'), 45, 'Sample Date'),
    new FixedExpense('Supplier Z', 14, 1200, 14, '15th', 1, new Date('08-27-2018'), new Date('01-20-2020'), 52)
  ];
